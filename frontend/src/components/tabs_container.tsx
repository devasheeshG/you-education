...
const TabsContainer: React.FC<TabsContainerProps> = ({ 
  ...
  return (
    <div className={`flex flex-col h-full border border-zinc-700 rounded-xl overflow-hidden bg-zinc-800/50 backdrop-blur-sm shadow-lg ${className}`}>
    ...
    case 'mindmap':
      return (
        <div className="bg-indigo-900/30 p-1 rounded-md">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-indigo-400">
