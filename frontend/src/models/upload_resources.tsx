    ...
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4">
      <div className="glassmorphism w-full max-w-lg p-6 animate-appear">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 text-transparent bg-clip-text">Upload Learning Resources</h2>
          <button 
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-lg font-medium text-gray-300">Drag & drop files or click to browse</p>
                  <p className="text-sm text-gray-500 mt-1">Supported formats: PDF, TXT, Markdown, PPT, DOCX</p>
                </div>
              </div>
                ...
                <div className="bg-gray-800 bg-opacity-50 rounded-lg p-4">
                  ...
                  <ul className="space-y-2">
                    {uploadedFiles.map((file, index) => (
                      <li key={index} className="flex justify-between items-center bg-gray-700 bg-opacity-50 rounded-md p-2">
          ...
          {activeTab === 'links' && (
            <div className="space-y-4">
              <div>
                <label htmlFor="youtubeLink" className="block text-sm font-medium mb-1 text-gray-300">
                  YouTube Link
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 px-3 py-2 bg-gray-800 border border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              ...
              <div>
                <label htmlFor="websiteLink" className="block text-sm font-medium mb-1 text-gray-300">
                  Website Link
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
